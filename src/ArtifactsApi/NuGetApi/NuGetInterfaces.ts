...
/**
 * Represents the upstreaming behavior for a NuGet feed.
 */
export interface UpstreamingBehavior {
    /** The UTC date since which upstream reads are allowed for the feed. */
    allowUpstreamReadSinceDate: string;
}

/**
 * Represents a dependency of a NuGet package version.
 * Imported from ArtifactsInterfaces to maintain consistency.
 */
