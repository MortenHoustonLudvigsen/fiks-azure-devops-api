...
declare module './NpmApi' {
  interface NpmApi {
     ...
     * @param patchOperations JSON Patch operations to update the package version (e.g., add/remove views)
     */
    updatePackage(project: string | undefined, feedId: string, packageName: string, packageVersion: string, patchOperations: NpmPackageVersionDetails[]): Promise<void>;
  }
}

Object.assign(NpmApi.prototype, {
  async updatePackage(this: NpmApi, project: string | undefined, feedId: string, packageName: string, packageVersion: string, patchOperations: NpmPackageVersionDetails[]): Promise<void> {
